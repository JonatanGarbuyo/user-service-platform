...
reviewer-spec        -> opencode/north-mini-code-free
```
...
2. **Spec — North Mini Code Free**: missing/incorrect requirements and scope creep against the implementation ticket and parent spec.
