...
reviewer-spec        -> opencode/deepseek-v4-flash-free
```
...
2. **Spec — DeepSeek V4 Flash Free**: missing/incorrect requirements and scope creep against the implementation ticket and parent spec.
